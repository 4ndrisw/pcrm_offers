...
<div class="modal fade offer-convert-modal" id="convert_to_invoice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        <?php echo form_open('admin/offers/convert_to_invoice/'.$offer->id,array('id'=>'offer_convert_to_invoice_form','class'=>'_transaction_form invoice-form')); ?>
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo _l('offer_convert_to_invoice'); ?></span>
                </h4>
            </div>
...
<script>
    ...
    init_color_pickers();
    init_items_sortable();
    validate_invoice_form('#offer_convert_to_invoice_form');
    <?php if($offer->assigned != 0){ ?>
     $('#convert_to_invoice #sale_agent').selectpicker('val',<?php echo $offer->assigned; ?>);
    <?php } ?>
