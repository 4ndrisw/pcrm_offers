...
class Schedule_office_pdf extends App_pdf
{
    protected $schedule;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_schedule_office_pdf.php';
        $actualPath = module_views_path('schedules','themes/' . active_clients_theme() . '/views/schedules/schedule_office_pdf.php');
